...
def readLangs():
    ...
    # 소스와 타깃 문장을 짝을지어 pair 변수에 추가한다 (※5)
    pair = []
...
def indexesFromSentence(lang, sentence):
    result = [lang.getWordIndex(word) for word in sentence.split(' ')]
    return result
...
output_words, attentions = evaluate(
    encoder1, attn_decoder1, "저 이 게임기 갖고 싶어요.")
...
evaluateAndShowAttention("운동화도 세탁이 되니?")
